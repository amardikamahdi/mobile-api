    ...
    <div x-data="mailbox">
        <div class="flex gap-5 relative sm:h-[calc(100vh_-_150px)] h-full">
            <div class="overlay bg-black/60 z-[5] w-full h-full absolute rounded-md hidden"
                :class="{ '!block xl:!hidden': isShowMailMenu }" @click="isShowMailMenu = !isShowMailMenu"></div>
            <div class="panel xl:block p-4 dark:gray-50 w-[250px] max-w-full flex-none space-y-3  xl:relative absolute z-10 xl:h-auto h-full hidden ltr:xl:rounded-r-md ltr:rounded-r-none rtl:xl:rounded-l-md rtl:rounded-l-none overflow-hidden "
                :class="{ '!block': isShowMailMenu }">
                <div class="flex flex-col h-full pb-16">
                    <div class="pb-5">
                        <button class="btn btn-primary w-full" type="button" @click="openMail('add')">New
                            Message</button>
                    </div>
                    <div class="perfect-scrollbar relative pr-3.5 -mr-3.5 h-full grow">
                        <div class="space-y-1">
                            <button type="button"
                                ...
                                :class="{
                                    'bg-gray-100 dark:text-primary text-primary dark:bg-[#181F32]': !isEdit &&
                                        selectedTab === 'inbox'
                                }"
                                ...
                                <div class="bg-primary-light dark:bg-[#060818] rounded-md py-0.5 px-2 font-semibold whitespace-nowrap"
                                    x-text="mailList && mailList.filter((d) => d.type == 'inbox').length"></div>
                            </button>
                            ...
                            <button type="button"
                                ...
                                <div class="bg-primary-light dark:bg-[#060818] rounded-md py-0.5 px-2 font-semibold whitespace-nowrap"
                                    x-text="mailList && mailList.filter((d) => !d.type || d.type === 'draft').length">
                                </div>
                            </button>
                                        ...
                                        <button type="button"
                                            ...
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                ...
                                                <path
                                                    ...
                                                    stroke="currentColor" stroke-width="1.5" />
                                                <path opacity="0.5" d="M15 6H9" stroke="currentColor"
                                                    stroke-width="1.5" stroke-linecap="round" />
                                            </svg>
                            ...
                            <button type="button"
                                ...
                                <div class="flex items-center">
                                    ...
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 rotate-180">
                                        <path opacity="0.5"
                                            d="M2 12C2 7.28595 2 4.92893 3.46447 3.46447C4.92893 2 7.28595 2 12 2C16.714 2 19.0711 2 20.5355 3.46447C22 4.92893 22 7.28595 22 12C22 16.714 22 19.0711 20.5355 20.5355C19.0711 22 16.714 22 12 22C7.28595 22 4.92893 22 3.46447 20.5355C2 19.0711 2 16.714 2 12Z"
                                            stroke="currentColor" stroke-width="1.5" />
                                        <path d="M7 18L7 15" stroke="currentColor" stroke-width="1.5"
                                            stroke-linecap="round" />
                                        <path d="M12 18V12" stroke="currentColor" stroke-width="1.5"
                                            stroke-linecap="round" />
                                        <path d="M17 18V9" stroke="currentColor" stroke-width="1.5"
                                            stroke-linecap="round" />
                                    </svg>
            ...
            <div class="panel p-0 flex-1 overflow-auto h-full">
                <div x-show="!selectedMail && !isEdit" class="flex flex-col h-full">
                    <div class="flex justify-between items-center flex-wrap-reverse gap-4 p-4">
                                            ...
                                            <ul x-cloak x-show="open" x-transition x-transition.duration.300ms
                                                ...
                                                <li>
                                                    <button type="button" class="w-full"
                                                        @click="toggle,setGroup('personal')">
                                                        <div class="w-2 h-2 rounded-full bg-primary ltr:mr-3 rtl:ml-3">
                                                        </div>
                                                        Personal
                                                    </button>
                                                </li>
                                                <li>
                                                    <button type="button" class="w-full"
                                                        @click="toggle,setGroup('work')">
                                                        <div class="w-2 h-2 rounded-full bg-warning ltr:mr-3 rtl:ml-3">
                                                        </div>
                                                        Work
                                                    </button>
                                                </li>
                                                <li>
                                                    <button type="button" class="w-full"
                                                        @click="toggle,setGroup('social')">
                                                        <div class="w-2 h-2 rounded-full bg-success ltr:mr-3 rtl:ml-3">
                                                        </div>
                                                        Social
                                                    </button>
                                                </li>
                                                <li>
                                                    <button type="button" class="w-full"
                                                        @click="toggle,setGroup('private')">
                                                        <div class="w-2 h-2 rounded-full bg-danger ltr:mr-3 rtl:ml-3">
                                                        </div>
                                                        Private
                                                    </button>
                                                </li>
                                                    ...
                                                    <button type="button" class="w-full" @click="setAction('read')">
                                                        ...
                                                        <svg width="24" height="24" viewBox="0 0 24 24"
                                                            ...
                                                            <path opacity="0.5" d="M5 9L9 10" stroke="currentColor"
                                                                stroke-width="1.5" stroke-linecap="round" />
                                                            <path opacity="0.5" d="M19 9L15 10"
                                                                stroke="currentColor" stroke-width="1.5"
                                                                stroke-linecap="round" />
                        ...
                        <div class="flex justify-between items-center sm:w-auto w-full">
                            <div class="flex items-center ltr:mr-4 rtl:ml-4">
                                ...
                                <div class="relative group">
                                    <input type="text" placeholder="Search Mail"
                                        class="form-input ltr:pr-8 rtl:pl-8 peer" x-model="searchText"
                                        @keyup="searchMails" />
                                    <div
                            ...
                            <div class="flex items-center">
                                <div class="ltr:mr-4 rtl:ml-4" x-tooltip="Settings" data-placement="top"
                                    role="tooltip">
                            ...
                            <button type="button" class="btn btn-outline-warning flex"
                                ...
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <path
                                        ...
                                        fill="currentColor" />
                                    <path opacity="0.5" d="M12 15V7" stroke="currentColor" stroke-width="1.5"
                                        stroke-linecap="round" />
                                    <path opacity="0.5" d="M8 13V9" stroke="currentColor" stroke-width="1.5"
                                        stroke-linecap="round" />
                                    <path opacity="0.5" d="M16 13V9" stroke="currentColor" stroke-width="1.5"
                                        stroke-linecap="round" />
                                </svg>
                                Work </button>
                                        ...
                                        <tr class="cursor-pointer " @click="selectMail(mail)">
                                            <td>
                                                <div class="flex items-center whitespace-nowrap ">
                                                    ...
                                                    <div class="ltr:mr-3 rtl:ml-3" x-tooltip="Star"
                                                    ...
                                                    <div class="ltr:mr-3 rtl:ml-3" x-tooltip="Important"
                                                        data-placement="top" role="tooltip">
                                                        <button type="button"
                                                    ...
                                                    <div class="dark:text-gray-300 whitespace-nowrap font-semibold"
                                                        :class="{
                                                            'text-gray-500 dark:text-gray-500 font-normal': !mail
                                                                .isUnread
                                                        }"
                                            ...
                                            <td>
                                                <div
                                                    class="font-medium text-white-dark overflow-hidden min-w-[300px] line-clamp-1">
                                                    <span
                                                        :class="{
                                                            'text-gray-800 dark:text-gray-300 font-semibold': mail
                                                                .isUnread
                                                        }">
                    ...
                    <div>
                        ...
                        <div class="p-4 relative">
                            <div class="flex flex-wrap">
                                ...
                                <div class="ltr:mr-2 rtl:ml-2 flex-1">
                                    <div class="flex items-center">
                                        <div class="text-lg ltr:mr-4 rtl:ml-4 whitespace-nowrap"
                                            x-text="selectedMail.firstName ? selectedMail.firstName + ' ' + selectedMail.lastName : selectedMail.email">
                                        </div>
                                        <div x-show="selectedMail.group" x-dynamictooltip="selectedMail.group"
                                            role="tooltip" class="ltr:mr-4 rtl:ml-4">
                                            <div class="w-2 h-2 rounded-full"
                                                :class="{
                                            ...
                                            <ul x-cloak x-show="open" x-transition x-transition.duration.300ms
                                                ...
                                                <li>
                                                    <div class="flex items-center px-4 py-2">
                                                        <div class="text-white-dark ltr:mr-2 rtl:ml-2 w-1/4">From:
                                                        </div>
                                                        <div class="flex-1"
                                                ...
                                                <li>
                                                    <div class="flex items-center px-4 py-2">
                                                        <div class="text-white-dark ltr:mr-2 rtl:ml-2 w-1/4">Date:
                                                        </div>
                                                        <div class="flex-1"
                                                            x-text="selectedMail.date + ', ' + selectedMail.time">
                                                        </div>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="flex items-center px-4 py-2">
                                                        <div class="text-white-dark ltr:mr-2 rtl:ml-2 w-1/4">Subject:
                                                        </div>
                                ...
                                <div>
                                    <div class="flex items-center justify-center space-x-3 rtl:space-x-reverse">
                                        <button x-tooltip="Star" data-placement="top" role="tooltip"
                                            type="button" class="enabled:hover:text-warning disabled:opacity-60"
                                            :class="{ 'text-warning': selectedMail.isStar }"
                                            @click="setStar(selectedMail.id)" :disabled="selectedTab === 'trash'">

                                            <svg width="24" height="24" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5"
                                        ...
                                        <button x-tooltip="Important" data-placement="top" role="tooltip"
                                            type="button" class="enabled:hover:text-primary disabled:opacity-60"
                                        ...
                                        <button x-tooltip="Reply" data-placement="top" role="tooltip"
                                            type="button" class="hover:text-info"
                                            ...
                                            <svg width="24" height="24" viewBox="0 0 24 24"
                                                ...
                                                <path d="M9.5 7L4.5 12L9.5 17" stroke="currentColor"
                                                    stroke-width="1.5" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                                <path opacity="0.5" d="M4.5 12L14.5 12C16.1667 12 19.5 13 19.5 17"
                                                    stroke="currentColor" stroke-width="1.5"
                                                    stroke-linecap="round" />
                                            </svg>
                                            <svg width="24" height="24" viewBox="0 0 24 24"
                                                ...
                                                <path d="M14.5 7L19.5 12L14.5 17" stroke="currentColor"
                                                    stroke-width="1.5" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                                <path opacity="0.5" d="M19.5 12L9.5 12C7.83333 12 4.5 13 4.5 17"
                                                    stroke="currentColor" stroke-width="1.5"
                                                    stroke-linecap="round" />
                                            </svg>
                                        </button>

                                        <button x-tooltip="Forward" data-placement="top" role="tooltip"
                                            type="button" class="hover:text-info"
                            ...
                            <div class="mt-8 prose dark:prose-p:text-white prose-p:text-sm md:prose-p:text-sm max-w-full prose-img:inline-block prose-img:m-0"
                                x-html="selectedMail.description">
                            </div>
                                ...
                                <div class="flex items-center flex-wrap mt-6">
                                    <template x-for="attachment in selectedMail.attachments">
                                        <button type="button"
                                            ...
                                            <template
                                                x-if="attachment.type !== 'zip' && attachment.type !== 'image' && attachment.type !== 'folder'">
                ...
                <template x-if="isEdit">
                    <div class="relative">
                        ...
                        <div
                            class="h-px bg-gradient-to-l from-indigo-900/20 via-black dark:via-white to-indigo-900/20 opacity-[0.1]">
                        </div>
                        <form class="p-6 grid gap-6">
                            <div>
                                <input type="text" class="form-input" placeholder="Enter To"
                                    x-model="params.to" />
                            </div>

                            <div>
                                <input type="text" class="form-input" placeholder="Enter Cc"
                                    x-model="params.cc" />
                            </div>
                            ...
                            <div>
                                <input id="file" type="file"
                                    ...
                                    multiple="multiple" accept="image/*,.zip,.pdf,.xls,.xlsx,.txt.doc,.docx"
                                    :value="params.file" />
                            </div>
                            ...
                            <div class="flex items-center ltr:ml-auto rtl:mr-auto mt-8">
                                ...
                                <button type="button" class="btn btn-success ltr:mr-3 rtl:ml-3"
                                    @click="saveMail('save')">Save</button>
