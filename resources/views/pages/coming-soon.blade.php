            ...
            <div class="max-w-[480px] mx-auto p-5 md:p-10">
                ...
                <form class="mb-5" @submit.prevent="window.location='/'">
                    <div class="relative max-w-[580px] mx-auto">
                        ...
                        <button type="submit"
                            class="btn btn-primary absolute top-0 ltr:right-0 rtl:left-0 py-2.5 rounded-bl-3xl">Subscribe</button>
                    </div>
                </form>
                <ul class="flex justify-center mb-10 mx-auto text-primary">
                    <li
                        class="ltr:pr-2 rtl:pl-2 ltr:mr-2 rtl:ml-2 ltr:border-r-2 rtl:border-l-2 border-[#ddd] dark:border-dark">
                        <a href="javascript:;">
