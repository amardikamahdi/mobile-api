        ...
        <div class="pt-5">
            ...
            <form action="" method="" class="mb-5">
                <div class="relative max-w-[580px] mx-auto">
                    ...
                    <button type="button"
                        class="btn btn-primary absolute top-1 ltr:right-1 rtl:left-1 shadow-none">Search</button>
                </div>
            </form>
            <p class="text-base mb-14 text-center font-semibold">Search instant answers & questions asked by popular
                users</p>
            <ul
                class="md:space-x-5 rtl:space-x-reverse grid grid-cols-2 md:grid-cols-0 md:flex justify-center mb-10 gap-5 md:gap-0">
                <li
                    ...
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg" class="w-16 h-16 text-primary mx-auto">
                        <path opacity="0.5"
            ...
            <div class="space-y-5 mb-10" x-data="{ active: null }">
                <div class="border border-[#ebedf2] dark:border-[#191e3a] rounded-md bg-white dark:bg-[#0e1726] ">
                    <div class="flex font-semibold p-5 cursor-pointer" :class="{ 'text-primary': active === 1 }"
                        x-on:click="active === 1 ? active = null : active = 1">

                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 ltr:mr-4 rtl:ml-4">
                            <path
                ...
                <div class="border border-[#ebedf2] dark:border-[#191e3a] rounded-md bg-white dark:bg-[#0e1726]">
                    <div class="flex font-semibold cursor-pointer p-5" :class="{ 'text-primary': active === 2 }"
                ...
                <div class="border border-[#ebedf2] dark:border-[#191e3a] rounded-md bg-white dark:bg-[#0e1726]">
                    <div class="flex font-semibold cursor-pointer p-5" :class="{ 'text-primary': active === 3 }"
                ...
                <div class="border border-[#ebedf2] dark:border-[#191e3a] rounded-md bg-white dark:bg-[#0e1726]">
                    <div class="flex font-semibold cursor-pointer p-5" :class="{ 'text-primary': active === 4 }"
                ...
                <div class="border border-[#ebedf2] dark:border-[#191e3a] rounded-md bg-white dark:bg-[#0e1726]">
                    <div class="flex font-semibold cursor-pointer p-5" :class="{ 'text-primary': active === 5 }"
                ...
                <div class="border border-[#ebedf2] dark:border-[#191e3a] rounded-md bg-white dark:bg-[#0e1726]">
                    <div class="flex font-semibold cursor-pointer p-5" :class="{ 'text-primary': active === 6 }"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5">
                    ...
                    <div class="flex">
                        <div class="rounded-full overflow-hidden ltr:mr-4 rtl:ml-4">
                            <img src="/assets/images/profile-1.jpeg"
                                class="w-11 h-11 object-cover" alt="profile1" />
                        </div>
                        <div class="flex-1">
                            <h4>Alma Clark</h4>
                            <p>06 May</p>
                ...
                <div
                    ...
                    <div class="flex">
                        <div class="rounded-full overflow-hidden ltr:mr-4 rtl:ml-4">
                            <img src="/assets/images/profile-2.jpeg"
                                class="w-11 h-11 object-cover" alt="profile2" />
                        </div>
                        <div class="flex-1">
                            <h4>Alma Clark</h4>
                            <p>06 May</p>
                ...
                <div
                    ...
                    <div class="flex">
                        <div class="rounded-full overflow-hidden ltr:mr-4 rtl:ml-4">
                            <img src="/assets/images/profile-3.jpeg"
                                class="w-11 h-11 object-cover" alt="profile3" />
                        </div>
                        <div class="flex-1">
                            <h4>Alma Clark</h4>
                            <p>06 May</p>
                ...
                <div
                    ...
                    <div class="flex">
                        <div class="rounded-full overflow-hidden ltr:mr-4 rtl:ml-4" />
                        <img src="/assets/images/profile-4.jpeg" class="w-11 h-11 object-cover"
                            alt="profile4">
                    </div>
                    <div class="flex-1">
                        <h4>Alma Clark</h4>
