    ...
    <div x-data="chart">
            ...
            <div class="panel h-full">
                ...
                <div>
                    <div class="space-y-6">
                        ...
                        <div class="flex">
                            <span
                                class="grid place-content-center w-9 h-9 rounded-md bg-danger-light dark:bg-danger text-danger dark:text-danger-light">
                        ...
                        <div class="flex">
                            <span
                                class="grid place-content-center w-9 h-9 rounded-md bg-primary-light dark:bg-primary text-primary dark:text-primary-light">
                ...
                <div class="p-6 bg-gradient-to-r from-[#4361ee] to-[#160f6b] min-h-[190px]">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <button type="button"
                            ...
                            <svg class="w-6 h-6 m-auto" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"
                ...
                <div class="table-responsive">
                    <table>
                        ...
                        <tbody>
                            <tr class="text-white-dark hover:text-black dark:hover:text-white-light/90 group">
                                <td class="min-w-[150px] text-black dark:text-white">
                                    <div class="flex"><img class="w-8 h-8 rounded-md ltr:mr-3 rtl:ml-3 object-cover"
                                ...
                                <td>
                                    <a class="text-danger flex items-center" href="javascript:;">
                                        ...
                                        <svg class="w-3.5 h-3.5 rtl:rotate-180 ltr:mr-1 rtl:ml-1" viewBox="0 0 24 24"
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
            ...
            <div class="panel h-full">
                ...
                <div class="flex items-center justify-between">
                    <div
                        class="w-full rounded-full h-5 p-1 bg-dark-light overflow-hidden shadow-3xl dark:shadow-none dark:bg-dark-light/10">
                        <div class="bg-gradient-to-r from-[#4361ee] to-[#805dca] w-full h-full rounded-full relative before:absolute before:inset-y-0 ltr:before:right-0.5 rtl:before:left-0.5 before:bg-white before:w-2 before:h-2 before:rounded-full before:m-auto"
                            style="width: 65%;"></div>
                    </div>
                ...
                <div class="perfect-scrollbar relative h-[360px] pr-3 -mr-3">
                    <div class="space-y-7">
                        <div class="flex">
                            ...
                            <div>
                                <h5 class="font-semibold dark:text-white-light">New project created : <a
                                        href="javascript:;" class="text-success">[Amerdev Admin Template]</a></h5>
                        ...
                        <div class="flex">
                            ...
                            <div>
                                <h5 class="font-semibold dark:text-white-light">Mail sent to <a href="javascript:;"
                                        class="text-white-dark">HR</a> and <a href="javascript:;"
                                        class="text-white-dark">Admin</a></h5>
        ...
        <div class="grid sm:grid-cols-3 xl:grid-cols-5 gap-6 mb-6">
                        ...
                        <div class="px-3 flex-initial w-full">
                            ...
                            <div>
                                <div
                                    ...
                                    <div class="bg-gradient-to-r from-[#009ffd] to-[#2a2a72] w-full h-full rounded-full relative before:absolute before:inset-y-0 ltr:before:right-0.5 rtl:before:left-0.5 before:bg-white before:w-2 before:h-2 before:rounded-full before:m-auto"
                                        style="width: 65%;"></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="px-3 flex-initial w-full">
                            ...
                            <div>
                                <div
                                    class="w-full rounded-full h-5 p-1 bg-dark-light overflow-hidden shadow-3xl dark:bg-dark-light/10 dark:shadow-none">
                                    <div class="bg-gradient-to-r from-[#a71d31] to-[#3f0d12] w-full h-full rounded-full relative before:absolute before:inset-y-0 ltr:before:right-0.5 rtl:before:left-0.5 before:bg-white before:w-2 before:h-2 before:rounded-full before:m-auto"
                                        style="width: 40%;"></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="px-3 flex-initial w-full">
                            ...
                            <div>
                                <div
                                    class="w-full rounded-full h-5 p-1 bg-dark-light overflow-hidden shadow-3xl dark:bg-dark-light/10 dark:shadow-none">
                                    <div class="bg-gradient-to-r from-[#fe5f75] to-[#fc9842] w-full h-full rounded-full relative before:absolute before:inset-y-0 ltr:before:right-0.5 rtl:before:left-0.5 before:bg-white before:w-2 before:h-2 before:rounded-full before:m-auto"
                                        style="width: 25%;"></div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="panel h-full p-0">
                <div class="flex p-5">
                    <div
                        class="bg-primary/10 text-primary rounded-xl w-11 h-11 flex justify-center items-center dark:bg-primary dark:text-white-light">
            ...
            <div class="panel h-full p-0">
                <div class="flex p-5">
                    <div
                        class="bg-danger/10 text-danger rounded-xl w-11 h-11 flex justify-center items-center dark:bg-danger dark:text-white-light">
            ...
            <div class="panel h-full p-0">
                <div class="flex p-5">
                    <div
                        class="bg-success/10 text-success rounded-xl w-11 h-11 flex justify-center items-center dark:bg-success dark:text-white-light">
        ...
        <div class="grid md:grid-cols-2 xl:grid-cols-3 gap-6">
            <div class="panel h-full">
                <div class="flex items-start border-b  border-[#e0e6ed] dark:border-[#1b2e4b] -m-5 mb-5 p-5">
                    <div class="ring-2 ring-white-light dark:ring-dark rounded-full ltr:mr-4 rtl:ml-4">
                        <img src="/assets/images/profile-1.jpeg" alt="image"
                ...
                <div>
                    ...
                    <div class="w-full absolute bottom-0 flex items-center justify-between p-5 -mx-5">
                        <div class="flex items-center">
                            ...
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                                class="w-5 h-5 text-info inline ltr:mr-1.5 rtl:ml-1.5 relative -top-0.5">
                                <path
                        ...
                        <a href="javascript:;"
                            class="flex items-center bg-success/30 text-success rounded-md px-1.5 py-1 text-xs hover:shadow-[0_10px_20px_-10px] hover:shadow-success">Read
                            More
            ...
            <div class="panel h-full">
                <div
                    class="flex items-center justify-between border-b  border-[#e0e6ed] dark:border-[#1b2e4b] -m-5 mb-5 p-5">
                    <div class="flex">
                        <div class="media-aside align-self-start">
                            <div class="ring-2 ring-white-light dark:ring-dark rounded-full ltr:mr-4 rtl:ml-4">
                                <img src="/assets/images/g-8.png" alt="image"
                                    class="w-10 h-10 rounded-full object-cover" />
                            </div>
                        </div>
                        <div class="font-semibold">
                ...
                <div class="font-semibold text-center pb-8">
                    ...
                    <div class="flex items-center justify-center gap-3 pb-8">
                        <img class="w-10 h-10 ring-2 ring-white-light dark:ring-dark rounded-lg overflow-hidden object-cover"
                            src="/assets/images/profile-1.jpeg" alt="image" />
                        <img class="w-10 h-10 ring-2 ring-white-light dark:ring-dark rounded-lg overflow-hidden object-cover"
                            src="/assets/images/profile-2.jpeg" alt="image" />
                        <img class="w-10 h-10 ring-2 ring-white-light dark:ring-dark rounded-lg overflow-hidden object-cover"
                            src="/assets/images/profile-3.jpeg" alt="image" />
                        <img class="w-10 h-10 ring-2 ring-white-light dark:ring-dark rounded-lg overflow-hidden object-cover"
                            src="/assets/images/profile-4.jpeg" alt="image" />
                    </div>

                    <div class="w-full absolute bottom-0 flex items-center justify-between p-5 -mx-5">
                        <a href="javascript:;"
                            class="btn btn-secondary btn-lg w-full border-0 bg-gradient-to-r from-[#3d38e1] to-[#1e9afe]">View
                            Details</a>
                    </div>
                </div>
            </div>
            ...
            <div class="panel h-full">
                <div
                    ...
                    <a href="javascript:;" class="flex font-semibold">
                        <div
                            class="bg-secondary w-10 h-10 rounded-md flex items-center justify-center text-white ltr:mr-4 rtl:ml-4">
                            <span>FD</span>
                        </div>
                        <div>
                            <h6>Figma Design</h6>
                ...
                <div class="group">
                    <div class="mb-5">
                        <div class="text-white-dark">
                            Doloribus nisi vel suscipit modi, optio ex repudiandae voluptatibus officiis commodi.
                            Nesciunt quas aut neque incidunt!
                        </div>
                    </div>
                    ...
                    <div class="flex items-end justify-between">
                        <div
                            class="flex items-center rounded-full bg-danger/20 px-2 py-1 text-xs text-danger font-semibold">
                        ...
                        <div
                            class="flex items-center justify-center group-hover:-space-x-2 rtl:space-x-reverse rtl:group-hover:space-x-reverse">
                            <span
                                class="bg-[#bfc9d4] dark:bg-dark w-9 h-9 rounded-full flex items-center justify-center text-white font-semibold transition-all duration-300 opacity-0 group-hover:opacity-100">+6</span>
                            <img class="w-9 h-9 border-2 border-white dark:border-dark rounded-full object-cover transition-all duration-300"
                                src="/assets/images/profile-6.jpeg" alt="image" />
                            <img class="w-9 h-9 border-2 border-white dark:border-dark rounded-full object-cover transition-all duration-300"
                                src="/assets/images/profile-7.jpeg" alt="image" />
                            <img class="w-9 h-9 border-2 border-white dark:border-dark rounded-full object-cover transition-all duration-300"
                                src="/assets/images/profile-8.jpeg" alt="image" />
                        </div>
                    </div>
                </div>
            </div>
